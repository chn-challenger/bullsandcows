...
describe Game do
  ...
  let(:player1)  { double(:player1, secret_number: 4321, add_guess: true, add_result: true) }
  let(:player2)  { double(:player2, secret_number: 1234, add_guess: true, add_result: true) }
